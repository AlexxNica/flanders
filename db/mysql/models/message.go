...
type Message struct {
	...
	MicroTS         null.Int64  `boil:"micro_ts" json:"micro_ts,omitempty" toml:"micro_ts" yaml:"micro_ts,omitempty"`
	Method          null.String `boil:"method" json:"method,omitempty" toml:"method" yaml:"method,omitempty"`
	ReplyReason     null.String `boil:"reply_reason" json:"reply_reason,omitempty" toml:"reply_reason" yaml:"reply_reason,omitempty"`
	Ruri            null.String `boil:"ruri" json:"ruri,omitempty" toml:"ruri" yaml:"ruri,omitempty"`
	RuriUser        null.String `boil:"ruri_user" json:"ruri_user,omitempty" toml:"ruri_user" yaml:"ruri_user,omitempty"`
	RuriDomain      null.String `boil:"ruri_domain" json:"ruri_domain,omitempty" toml:"ruri_domain" yaml:"ruri_domain,omitempty"`
	FromUser        null.String `boil:"from_user" json:"from_user,omitempty" toml:"from_user" yaml:"from_user,omitempty"`
	FromDomain      null.String `boil:"from_domain" json:"from_domain,omitempty" toml:"from_domain" yaml:"from_domain,omitempty"`
	FromTag         null.String `boil:"from_tag" json:"from_tag,omitempty" toml:"from_tag" yaml:"from_tag,omitempty"`
	ToUser          null.String `boil:"to_user" json:"to_user,omitempty" toml:"to_user" yaml:"to_user,omitempty"`
	ToDomain        null.String `boil:"to_domain" json:"to_domain,omitempty" toml:"to_domain" yaml:"to_domain,omitempty"`
	ToTag           null.String `boil:"to_tag" json:"to_tag,omitempty" toml:"to_tag" yaml:"to_tag,omitempty"`
	PidUser         null.String `boil:"pid_user" json:"pid_user,omitempty" toml:"pid_user" yaml:"pid_user,omitempty"`
	ContactUser     null.String `boil:"contact_user" json:"contact_user,omitempty" toml:"contact_user" yaml:"contact_user,omitempty"`
	AuthUser        null.String `boil:"auth_user" json:"auth_user,omitempty" toml:"auth_user" yaml:"auth_user,omitempty"`
	Callid          null.String `boil:"callid" json:"callid,omitempty" toml:"callid" yaml:"callid,omitempty"`
	CallidAleg      null.String `boil:"callid_aleg" json:"callid_aleg,omitempty" toml:"callid_aleg" yaml:"callid_aleg,omitempty"`
	Via1            null.String `boil:"via_1" json:"via_1,omitempty" toml:"via_1" yaml:"via_1,omitempty"`
	Via1Branch      null.String `boil:"via_1_branch" json:"via_1_branch,omitempty" toml:"via_1_branch" yaml:"via_1_branch,omitempty"`
	Cseq            null.String `boil:"cseq" json:"cseq,omitempty" toml:"cseq" yaml:"cseq,omitempty"`
	Diversion       null.String `boil:"diversion" json:"diversion,omitempty" toml:"diversion" yaml:"diversion,omitempty"`
	...
	SourceIp        null.String `boil:"source_ip" json:"source_ip,omitempty" toml:"source_ip" yaml:"source_ip,omitempty"`
	SourcePort      null.Int    `boil:"source_port" json:"source_port,omitempty" toml:"source_port" yaml:"source_port,omitempty"`
	DestinationIp   null.String `boil:"destination_ip" json:"destination_ip,omitempty" toml:"destination_ip" yaml:"destination_ip,omitempty"`
	DestinationPort null.Int    `boil:"destination_port" json:"destination_port,omitempty" toml:"destination_port" yaml:"destination_port,omitempty"`
	ContactIp       null.String `boil:"contact_ip" json:"contact_ip,omitempty" toml:"contact_ip" yaml:"contact_ip,omitempty"`
	ContactPort     null.Int    `boil:"contact_port" json:"contact_port,omitempty" toml:"contact_port" yaml:"contact_port,omitempty"`
	OriginatorIp    null.String `boil:"originator_ip" json:"originator_ip,omitempty" toml:"originator_ip" yaml:"originator_ip,omitempty"`
	OriginatorPort  null.Int    `boil:"originator_port" json:"originator_port,omitempty" toml:"originator_port" yaml:"originator_port,omitempty"`
	CorrelationID   null.String `boil:"correlation_id" json:"correlation_id,omitempty" toml:"correlation_id" yaml:"correlation_id,omitempty"`
	CustomField1    null.String `boil:"custom_field1" json:"custom_field1,omitempty" toml:"custom_field1" yaml:"custom_field1,omitempty"`
	CustomField2    null.String `boil:"custom_field2" json:"custom_field2,omitempty" toml:"custom_field2" yaml:"custom_field2,omitempty"`
	CustomField3    null.String `boil:"custom_field3" json:"custom_field3,omitempty" toml:"custom_field3" yaml:"custom_field3,omitempty"`
	Proto           null.Int    `boil:"proto" json:"proto,omitempty" toml:"proto" yaml:"proto,omitempty"`
	Family          null.Int    `boil:"family" json:"family,omitempty" toml:"family" yaml:"family,omitempty"`
	RTPStat         null.String `boil:"rtp_stat" json:"rtp_stat,omitempty" toml:"rtp_stat" yaml:"rtp_stat,omitempty"`
	Type            null.Int    `boil:"type" json:"type,omitempty" toml:"type" yaml:"type,omitempty"`
	Node            null.String `boil:"node" json:"node,omitempty" toml:"node" yaml:"node,omitempty"`
